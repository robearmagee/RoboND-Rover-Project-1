...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"Rocks Found: "+str(np.sum(Rover.samples_found)), (0, 55), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Current Mode: "+str(Rover.mode), (0, 70),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) ## added for testing
      cv2.putText(map_add,"Near Sample?: "+str(Rover.near_sample), (0, 85),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1) ## added for testing
